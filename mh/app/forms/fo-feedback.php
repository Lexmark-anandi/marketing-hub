...
$FORM = '
<form enctype="multipart/form-data" onsubmit="return false" action="" method="post" name="formFeedback" id="formFeedback" class="formFeedback">
	<div class="formRow formRowSpace">
		<div class="formLabel"><strong>' . $TEXT['feedbackText'] . '</strong></div>
		<div class="formField">
			<div class="slidecontainer">
			  <input type="range" min="1" max="5" value="3" class="slider" id="feedbackRange" name="feedbackRange">
			</div>
			<div style="float:left">' . $TEXT['notSatisfied'] . '</div>
			<div style="float:right">' . $TEXT['completelySatisfied'] . '</div>
		</div>
	</div>

	<div class="formRow formRowNoBorder">
		<div class="formLabel"><label for="feedbackAdditional"><strong>' . $TEXT['additionalFeedback'] . '</strong></label></div>
		<div class="formField"><textarea class="textfield h100" name="feedbackAdditional" id="feedbackAdditional"></textarea></div>
	</div>
</form>
';
