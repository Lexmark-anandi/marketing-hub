...
if($varSQL['frame'] == 'first'){
	...
	$queryC->bindValue(':duration', $varSQL['duration'], PDO::PARAM_INT);
	$queryC->bindValue(':showframe', 1, PDO::PARAM_INT);
...
if($varSQL['frame'] == 'product'){
	...
	$queryPr->bindValue(':duration', $varSQL['duration'], PDO::PARAM_INT);
	$queryPr->execute();
}
