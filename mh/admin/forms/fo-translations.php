...
if($CONFIG['page']['id_data'] == 0){
	include_once($CONFIG['system']['directoryRoot'] . $CONFIG['system']['pathFormsAdmin'] . 'fo-translations-new.php');
}else{
...
//	$formfile = $CONFIG['system']['directoryRoot'] . $CONFIG['system']['pathFormsAdmin'] . 'fo-translations-edit-' . $rows[0]['formfile'] . '.php';
	$formfile = $CONFIG['system']['directoryRoot'] . $CONFIG['system']['pathFormsAdmin'] . 'fo-translations-edit.php';
