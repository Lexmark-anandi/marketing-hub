...
$query = $CONFIG['dbconn'][0]->prepare('
									...
									WHERE ' . $CONFIG['db'][0]['prefix'] . '_campaigns2products_.del = (:nultime)
										AND ' . $CONFIG['db'][0]['prefix'] . '_campaigns2products_.id_campid = (:id)
									');
$query->bindValue(':nultime', '0000-00-00 00:00:00', PDO::PARAM_STR);
...
######################################################
$FORM .= '
	<div class="fieldset" data-formtab="Step1C" data-step="1">
		<div class="formRow formRowNoBorder">
			<div class="formLabel">
...
######################################################
$FORM .= '
	<div class="fieldset fieldsetSelectassign" data-formtab="Step3C" data-step="3">
...
// Step 4
######################################################
$FORM .= '<div class="fieldset fieldsetFullWidth fieldsetGrid" data-formtab="Step4P" data-step="4">';
$FORM .= '</div>';
#############################################################################
