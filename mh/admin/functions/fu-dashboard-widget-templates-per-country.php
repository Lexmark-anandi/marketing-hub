...
$functionFile = 'fu-' . $CONFIG['aModul']['modul_name'] . '-widget-templates-per-country.php';
$functionFileOne2n = 'fu-' . $CONFIG['aModul']['modul_name'] . '-widget-templates-per-country-one2n.php';
$functionFilePre = 'fu-' . $CONFIG['aModul']['modul_name'] . '-widget-templates-per-country-pre.php';
