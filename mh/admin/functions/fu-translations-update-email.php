<?php 
include_once(__DIR__ . '/fu-templates-update-email.php');
...
//	#########################################
//	// save pages
//	if(isset($aArgsSave['aData']['id_etid'])){
//		$page = 1;
//
...
//		$aArgsN['n_' . $tpid]['data']['id_etid'] = $aArgsSave['aData']['id_etid'];
//		$aArgsN['n_' . $tpid]['data']['kiado_code'] = '';
//		$aArgsN['n_' . $tpid]['data']['file_original'] = '';
...
//		$qry .= '(' . $aArgsSaveN['n_' . $tpid]['primarykey'] . ', id_tempid, id_bfid, page, id_count, id_lang, id_dev, id_cl, create_at, create_from, change_from' . $col . ') ';
//		$qry .= 'VALUES ';					
//		$qry .= '(:id, :id_tempid, :id_bfid, :page, :id_count, :id_lang, :id_dev, :id_cl, :create_at, :create_from, :create_from' . $val . ') '; 
