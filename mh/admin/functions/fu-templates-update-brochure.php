...
foreach($rows as $row){
    ...
    //	var_dump($aArgs['data']);
    //	if(is_array($aArgs['data']['specsheet_original']) && count($aArgs['data']['specsheet_original']) > 1 && $aArgs['data']['specsheet_original'][0] == 0) array_shift($aArgs['data']['specsheet_original']);
