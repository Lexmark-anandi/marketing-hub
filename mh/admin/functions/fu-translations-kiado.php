<?php
include_once(__DIR__ . '/fu-templates-kiado.php');
...
//		$aArgsSaveT['orgfieldname'] = $varSQL['orgfieldname'];
//		$aArgsSaveT['multiple'] = $varSQL['multiple'];
