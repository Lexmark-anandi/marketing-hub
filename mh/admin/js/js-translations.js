(function () {
	...
	// Send Form
	// ##################################################### 
    window['f_##modul_name##']['sendForm'] = function (obj, action) { 
		window['f_##modul_name##']['saveBannername'](obj);
    ...
    window['f_##modul_name##']['saveBannername'] = function (obj) { 
		...
		if($('#modul_' + obj.modulpath + ' .formLeft .bannername').length > 0 || $('#modul_' + obj.modulpath + ' .formLeft .promotitle').length > 0 || $('#modul_' + obj.modulpath + ' .formLeft .campaigntitle').length > 0){
			var bannername = {};
			$('#modul_' + obj.modulpath + ' .formLeft .bannername').each(function(){
				bannername[$(this).attr('data-bfid')] = $(this).val();
			})
			var data = 'bannernames=' + JSON.stringify(bannername);
			
			if($('#modul_' + obj.modulpath + ' .formLeft .promotitle').length > 0){
				data += '&promotitle=' + $('#modul_' + obj.modulpath + ' .formLeft .promotitle').val();
				data += '&promid=' + $('#modul_' + obj.modulpath + ' .formLeft .promotitle').attr('data-promid');
			}
			if($('#modul_' + obj.modulpath + ' .formLeft .campaigntitle').length > 0){
				data += '&campaigntitle=' + $('#modul_' + obj.modulpath + ' .formLeft .campaigntitle').val();
				data += '&campid=' + $('#modul_' + obj.modulpath + ' .formLeft .campaigntitle').attr('data-campid');
			}
			
			$.ajax({  
				url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-update-bannernames.php', 
				data: data,    
				type: 'post',          
				cache: false,  
				headers: {
    ...
    window['f_##modul_name##']['cbLoadFormSuccess'] = function (obj) { 
		$('#modul_' + obj.modulpath + ' .formLeft .formTabs li[data-formtab="countries"]').css('display', 'none');
		$('#modul_' + obj.modulpath + ' .formRight .formRightInner').css('display', 'none');
...
//		});
		...
		$('#form_' + obj.modulpath + ' .formRight .templatePublish').off('click');
		$('#form_' + obj.modulpath + ' .formRight .templatePublish').on('click', function(){
    ...
    window['f_##modul_name##']['cbLoadDataSuccess'] = function (obj) {
		...
		var selSrc = $('#form_' + obj.modulpath + ' .formLeft input[name="contentselect"]').val();
		if(selSrc == 'kiado'){
    ...
    window['f_##modul_name##']['loadCountriesKiado'] = function (obj) { 
		...
		var data = 'kiado=' + kiado;
		
		if(kiado != ''){
			$('#form_' + obj.modulpath + ' .formLeft .formRowCountriesKiado .countryTableRow').each(function(){
				var count2lang = $(this).attr('data-count2lang');
				data += '&count2lang=' + count2lang;
				
				$.ajax({  
					url: objSystem.directoryInstallation + objSystem.pathFormsAdmin + 'fo-translations-countries-kiado.php', 
					data: data,    
					type: 'post',          
					cache: false,  
					headers: {
    ...
    window['f_##modul_name##']['cbSaveDataSubmitSuccess'] = function (obj) { 
		...
		if($('#modul_' + obj.modulpath + ' .formLeft input[name="contentselect"]').val() == 'kiado'){
			for(var i = 50; i < 1000; i += 150){
				window.setTimeout(function(){waiting('#modul_' + obj.modulpath)}, i);
			}
			
			$.ajax({  
				url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-kiado.php', 
				data: data,    
				type: 'post',          
				cache: false,  
				headers: {
				...
				success: function (result, status, jqXHR) {
					...
					$.ajax({  
						url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-kiado-local.php', 
						data: data,    
						type: 'post',          
						cache: false,  
						headers: {
    ...
    window['f_##modul_name##']['initFormComponents'] = function (obj) { 
		...
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsTop').css('top', (hTab - 1) + 'px');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsTop').css('bottom', hFooter + 'px');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsBottom').css('height', hFooter + 'px');
    ...
    window['f_##modul_name##']['loadComponents'] = function (obj) { 
		...
		if(objComponents.id_temp != obj.id_data){
			...
			$.ajax({  
				url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-components-read.php', 
				data: data,    
				type: 'post',          
				cache: false,  
				headers: {
				...
				success: function (result, status, jqXHR) {
					...
					if(objResult.preview == ''){
						...
						$('#modul_' + obj.modulpath + ' .formRight .formRightInner').css('display', '');
						...
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails').html(thumbnails);
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails .formComponentThumbOuter:first').addClass('formComponentThumbOuterActive');
						
						$('#modul_' + obj.modulpath + ' .formLeft .formBannerformats').html(objResult.bannerformats);
						$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground').html(objResult.preview);
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsComponents').html(objResult.components);
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm').html(objResult.toolsform);
	
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .colorpicker').spectrum({
							preferredFormat: 'hex',
						...
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .componentformfield').off('input');
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .componentformfield').on('input', function(){
							window['f_##modul_name##']['changeFormatComponent'](obj, this);
						});
		
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .booleanfield').off('change');
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .booleanfield').on('change', function(){
							window['f_##modul_name##']['changeFormatComponent'](obj, this);
						});
		
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .buttonRemoveComponent').off('click');
						if($('.formLeft input[name="id_caid"]').val() != 3){
							$('.formComponentsForm .buttonRemoveComponent').css('opacity', '');
							$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .buttonRemoveComponent').on('click', function(){
						...
						initFieldsUpload(obj, '#modul_' + obj.modulpath + ' .formRight');
						window['f_##modul_name##']['initConfigurationIconPaste'](obj);
								
						$('#form_' + obj.modulpath + ' .formRight .formButtonCompFileupload').off('click');
						$('#form_' + obj.modulpath + ' .formRight .formButtonCompFileupload').on('click', function(){
							window['f_##modul_name##']['checkComponentFileupload'](obj, this);
						});
		
						$('#form_' + obj.modulpath + ' .formRight textarea.wysiwyg').each(function(){
							...
							for (var i in CKEDITOR.instances) {
								CKEDITOR.instances[i].on('change', function(e) {
									var compPageId = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-pageid');
									var compId = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('id');
									CKEDITOR.instances[i].document.getBody().setStyle('background-color', '#dcd2b0');
									var thisHTML = e.editor.getData();
									var outHTML = window['f_##modul_name##']['resizeFontsize'](thisHTML);
									$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive .content').html(outHTML);
...
//								}
						...
						$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents .compboxOuter').remove();
						...
						$('#form_' + obj.modulpath + ' .formRight .configComponentSave').off('click');
						$('#form_' + obj.modulpath + ' .formRight .configComponentSave').addClass('buttonDeactivate');
						if($('#form_' + obj.modulpath + ' .formLeft input[name="id_caid"]').val() != 1){
							$('#form_' + obj.modulpath + ' .formRight .configComponentSave').removeClass('buttonDeactivate');
							$('#form_' + obj.modulpath + ' .formRight .configComponentSave').on('click', function(){
								var objDialog = {};
								objDialog.urlForm = objSystem.directoryInstallation + objSystem.pathFormsAdmin + 'fo-translations-configuration-save.php';
								objDialog.el = this;
						...
						$('#form_' + obj.modulpath + ' .formRight .configComponentLoad').off('click');
						$('#form_' + obj.modulpath + ' .formRight .configComponentLoad').addClass('buttonDeactivate');
						if($('#form_' + obj.modulpath + ' .formLeft input[name="id_caid"]').val() != 1){
							$('#form_' + obj.modulpath + ' .formRight .configComponentLoad').removeClass('buttonDeactivate');
							$('#form_' + obj.modulpath + ' .formRight .configComponentLoad').on('click', function(){
								var objDialog = {};
								objDialog.urlForm = objSystem.directoryInstallation + objSystem.pathFormsAdmin + 'fo-translations-configuration-load.php';
								objDialog.el = this;
								objDialog.title = objText.ConfigurationLoad;
								objDialog.caid = $('#modul_' + obj.modulpath + ' .formLeft input[name="id_caid"]').val();
						...
						$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').off('mouseover');
						$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').on('mouseover', function(){
							$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').removeClass('formComponentOuterHover');
							$(this).addClass('formComponentOuterHover');
						});
						
						$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').off('mouseout');
						$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').on('mouseout', function(){
							$(this).removeClass('formComponentOuterHover');
						});
						
						$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').off('click');
						$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').on('click', function(){
						...
						$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents').on('click', function(){
    ...
    window['f_##modul_name##']['initFormComponentThumbs'] = function (obj) { 
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').off('mouseover');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').on('mouseover', function(){
			$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').removeClass('formComponentThumbOuterHover');
			$(this).addClass('formComponentThumbOuterHover');
		});
		
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').off('mouseout');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').on('mouseout', function(){
			$(this).removeClass('formComponentThumbOuterHover');
		});
		
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').off('click');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').on('click', function(){
			$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').removeClass('formComponentThumbOuterActive');
    ...
    window['f_##modul_name##']['loadComponentsPage'] = function (obj) { 
		...
		var objModul = (obj.id_mod_parent == 0) ? objUser.pages2moduls[obj.id_page].moduls['i_' + obj.id_mod] : objUser.childmoduls[obj.id_mod_parent]['i_' + obj.id_mod];
		var page = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-page');
		var tp = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-tp');
		var data = 'page=' + page;
		data += '&tp=' + tp;
		...
		if(tp == undefined){
			...
			$.ajax({  
				url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-componentspage-read.php', 
				data: data,    
				type: 'post',          
				cache: false,  
				headers: {
				...
				success: function (result, status, jqXHR) {
					...
					for(var group in objResult.thumbnails){
						if($('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails .formComponentThumbgroup[data-group="' + group + '"]').length > 0){
							var numPages = 0;
							
							for(var page in objResult.thumbnails[group]){
								numPages++;
							
								if($('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails .formComponentThumbgroup[data-group="' + group + '"] .formComponentThumbOuter[data-page="' + page + '"]').length > 0){
									$('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails .formComponentThumbgroup[data-group="' + group + '"] .formComponentThumbOuter[data-page="' + page + '"] .formComponentThumb img').attr('src', objResult.thumbnails[group][page].src);
								}else{
									$('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails .formComponentThumbgroup[data-group="' + group + '"]').append('<div class="formComponentThumbOuter" data-page="' + page + '" data-tp="' + objResult.thumbnails[group][page].tp + '" data-pageid="' + objResult.thumbnails[group][page].pageid + '"><div class="formComponentThumb"><img src="' + objResult.thumbnails[group][page].src + '"></div><div class="formComponentPage">' + objResult.thumbnails[group][page].pagelabel + '</div></div>');
								}
							}
							$('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails .formComponentThumbgroup[data-group="' + group + '"] .formComponentThumbOuter').each(function(){
    ...
    window['f_##modul_name##']['loadPageComponents'] = function (obj) { 
		...
		if($('#modul_' + obj.modulpath + ' .wFormFilter').length == 0){
			$('#modul_' + obj.modulpath + ' .formRight .booleanfield[value="0"]').parent().css('display', 'none');
		}else{
			if(obj.id_data == 0 || (objModul.activeSettings.formCountry == 0 && objModul.activeSettings.formLanguage == 0 && objModul.activeSettings.formDevice == 0)){
				...
				$('#modul_' + obj.modulpath + ' .formRight .booleanfield[value="0"]').parent().css('display', '');
			}
		}
		...
		if(objComponents.pages['page_' + compPageId] != undefined){
			for(key in objComponents.pages['page_' + compPageId]){
				...
				$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents').append('<div class="compboxOuter comboxOuter_' + objComponents.pages['page_' + compPageId][key].id_caid + '_' + objComponents.pages['page_' + compPageId][key].id_tcid + '" id="' + key + '" data-tcid="' + objComponents.pages['page_' + compPageId][key].id_tcid + '" data-tpeid="' + objComponents.pages['page_' + compPageId][key].id_tpeid + '"><div class="content">' + content + '</div></div>');

				if(objComponents.pages['page_' + compPageId][key]['transrequired_default'] == objText.yes || objComponents.pages['page_' + compPageId][key]['transrequired'] == 1){
					$('#' + key).addClass('compboxTranslation');
				}
				...
				if(objComponents.pages['page_' + compPageId][key]['fixed'] == 1 || $('.formLeft input[name="id_caid"]').val() == 3){
    ...
    window['f_##modul_name##']['resizeComponentsPage'] = function (obj) { 
		...
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsTools').css('width', '');

		var imgWidthOrg = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground img').attr('data-width');
		var imgHeightOrg = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground img').attr('data-height');
		var previewWidthAll = $('#modul_' + obj.modulpath + ' .formRight .formComponentsPreview').outerWidth();
		var previewWidth = $('#modul_' + obj.modulpath + ' .formRight .formComponentsPreview').outerWidth() - $('#modul_' + obj.modulpath + ' .formRight .formComponentsTools').outerWidth();
		var previewHeight = $('#modul_' + obj.modulpath + ' .formRight .formComponentsPreview').outerHeight();
		...
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsTools').css('width', wTools + 'px');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsTools').css('display', 'block');

		$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground').css('width', imgWidthReal + 'px');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground').css('height', imgHeightReal + 'px');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents').css('width', imgWidthReal + 'px');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents').css('height', imgHeightReal + 'px');
	}; 
    ...
    window['f_##modul_name##']['createPlaceholder'] = function (obj) { 
		...
		if($('#modul_' + obj.modulpath + ' .formRight .formComponentOuterActive').length > 0){
			$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents').selectable({
				distance: 20,
				start: function(e) {
				...
				stop: function(e) {
					...
					var id_tcid = $('#modul_' + obj.modulpath + ' .formRight .formComponentOuterActive').attr('data-id');
					var compPageId = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-pageid');
					...
					objComponentNew.docWidth = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground img').innerWidth();
					objComponentNew.docHeight = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground img').innerHeight();
					...
					objComponentNew.id_tpid = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-tp');
					objComponentNew.page = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-page');
					objComponentNew.id_tcid = id_tcid;
					objComponentNew.id_caid = $('#modul_' + obj.modulpath + ' .formLeft input[name="id_caid"]').val();
					
					
					var data = 'comp=' + JSON.stringify(objComponentNew);;
					
					$.ajax({  
						url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-components-insert.php', 
						data: data,    
						type: 'post',          
						cache: false,  
						headers: {
						...
						success: function (result, status, jqXHR) {
							...
							//## append a new div ##
							$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents').append('<div class="compboxOuter comboxOuter_' + objComponentNew.id_caid + '_' + objComponentNew.id_tcid + '" id="' + compId + '" data-tcid="' + id_tcid + '" data-tpeid="' + id_tpeid + '"><div class="content">' + objConfigComponents[id_tcid].default_content + '</div></div>');
    ...
    window['f_##modul_name##']['dragStopPlaceholder'] = function (obj, event, ui, el) { 
		...
		var docWidth = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground img').innerWidth();
		var docHeight = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewBackground img').innerHeight();
    ...
    window['f_##modul_name##']['resizeStopPlaceholder'] = function (obj, event, ui, el) { 
		...
		$('#modul_' + obj.modulpath + ' .formRight #' + compId).css('width', compWidthPerc + '%');
		$('#modul_' + obj.modulpath + ' .formRight #' + compId).css('height', compHeightPerc + '%');
    ...
    window['f_##modul_name##']['activatePlaceholder'] = function (obj, el) { 
		...
		$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter').removeClass('formComponentOuterActive');
		$('#modul_' + obj.modulpath + ' .formRight .formComponentOuter[data-id="' + id_tcid + '"]').addClass('formComponentOuterActive');
		
		
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldset').removeClass('fieldsetActive');
		...
		$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldset[data-tcid="' + id_tcid + '"]').addClass('fieldsetActive');

		$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconCopy').off('click');
		$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconCopy').on('click', function(){
			window['f_##modul_name##']['copyPlaceholder'](obj);
		});
		$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconCopy').addClass('componentsConfigurationIconActive');
    ...
    window['f_##modul_name##']['deactivatePlaceholder'] = function (obj, el) { 
		if(deactivateCompbox == 1 && $('.compboxOuterActive').length > 0) {
			...
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconCopy').off('click');
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconCopy').removeClass('componentsConfigurationIconActive');
		}
    ...
    window['f_##modul_name##']['copyPlaceholder'] = function (obj) { 
		var pageid = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-pageid');
		var compid = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('id');
    ...
    window['f_##modul_name##']['pastePlaceholder'] = function (obj, el) { 
		...
		if($('.formComponentOuter[data-id="' + tcidClipboard + '"]').length > 0){
			...
			var page = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-page');
			var bfid = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-bfid');
			var tpid = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-tp');
			var pageid = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-pageid');
			...
			$.ajax({  
				url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-components-paste.php', 
				data: data,    
				type: 'post',          
				cache: false,  
				headers: {
				...
				success: function (result, status, jqXHR) {
					...
					var elem = $('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents .compboxOuterActive');
    ...
    window['f_##modul_name##']['initConfigurationIconPaste'] = function (obj) { 
		if(jQuery.isEmptyObject(objClipboard)){
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconPaste').off('click');
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconPaste').removeClass('componentsConfigurationIconActive');
		}else{
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconPaste').off('click');
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconPaste').on('click', function(){
				window['f_##modul_name##']['pastePlaceholder'](obj, this);
			});
	
			$('#modul_' + obj.modulpath + ' .formRight .componentsConfigurationIconPaste').addClass('componentsConfigurationIconActive');
		}
	}; 
		
	
    window['f_##modul_name##']['formatThumbEditable'] = function (obj, el) { 
		$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter').removeClass('formComponentThumbOuterEditable');
		for(key in objComponents.pages){
			for(comp in objComponents.pages[key]){
				var page = objComponents.pages[key][comp].pageid;
				$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter[data-pageid="' + page + '"]').addClass('formComponentThumbOuterEditable');
			}
		}
	}; 
    ...
    window['f_##modul_name##']['changeFormatComponent'] = function (obj, el) { 
		var compPageId = $('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').attr('data-pageid');
		var compId = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('id');
		var id_tcid = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('data-tcid');
		...
		switch(fieldname){
			case('content'):
				if(objConfigComponents[id_tcid].fields['content'].type == 'text'){
					...
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive .content').html(val);
				...
				if(id_tcid == 17){
					...
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive .content').html(objComponentsTextmoduls[val]);
					objComponents.pages['page_' + compPageId][compId][fieldname] = val;
				}
				break;
			...
			case('fontsize'):
				var val = $(el).val();
				objComponents.pages['page_' + compPageId][compId][fieldname] = val;
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-size', (val * componentFactor) + 'pt');
				break;
			
			case('fontcolor'):
				var val = $(el).val();
				objComponents.pages['page_' + compPageId][compId][fieldname] = val;
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('color', val);
				break;
			
			case('background_color'):
				var val = $(el).val();
				objComponents.pages['page_' + compPageId][compId][fieldname] = val;
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('background-color', val);
				break;
			...
			case('fontstyle'):
				...
				switch(val){
					case('0'):
						$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-weight', 'normal');
						$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-style', 'normal');
						break;
					
					case('1'):
						$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-weight', 'bold');
						$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-style', 'normal');
						break;
					
					case('2'):
						$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-weight', 'normal');
						$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('font-style', 'italic');
						break;
			...
			case('alignment'):
				var val = $(el).val();
				objComponents.pages['page_' + compPageId][compId][fieldname] = val;
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').css('text-align', val);
				if(id_tcid == 10){
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('contactalignleft');
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('contactaligncenter');
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('contactalignright');
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').addClass('contactalign' + val);
				}
				if(id_tcid == 11 || id_tcid == 12 || id_tcid == 15){
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('alignleft');
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('aligncenter');
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('alignright');
					$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').addClass('align' + val);
				}
				break;
			...
			case('verticalalignment'):
				var val = $(el).val();
				objComponents.pages['page_' + compPageId][compId][fieldname] = val;
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('verticalaligntop');
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('verticalalignmiddle');
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').removeClass('verticalalignbottom');
				$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').addClass('verticalalign' + val);
				break;
		...
		window['f_##modul_name##']['resizeStopPlaceholder'](obj, '', '', $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive'));
	}; 
			...
			for(key in objConfigComponents[id_tcid].fields){
				...
				switch(fieldname){
					case('content'):
						...
						val = val.replace(/(<br \/>)/g, '\r\n');
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + '"]').val(val);
						break;
	
					case('transrequired'):
						var val = objComponents.pages['page_' + compPageId][compId][fieldname];
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + '"][value="' + val + '"]').prop('checked', true);
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + '"][value="0"]').parent().find('.valuedefault').html('(' + objComponents.pages['page_' + compPageId][compId][fieldname + '_default'] + ')');
						break;
	
					case('maxchars'):
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + '"]').val(objComponents.pages['page_' + compPageId][compId][fieldname]);
						window['f_##modul_name##']['checkMaxChars'](obj);
						break;
					...
					case('fontcolor'):
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + '"]').spectrum('set', objComponents.pages['page_' + compPageId][compId][fieldname]);
						break;
					...
					case('fontstyle'):
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + ' option').prop('selected', false);
						$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="' + fieldname + '"] option[value="' + objComponents.pages['page_' + compPageId][compId][fieldname] + '"]').prop('selected', true);
						break;
    ...
    window['f_##modul_name##']['removeComponent'] = function (obj, el) { 
		...
		var compId = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('id');
		var id_tcid = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('data-tcid');
		var id_tpeid = $('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('data-tpeid');
		
		var data = 'tpeid=' + id_tpeid;
		
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-components-delete.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				window['f_##modul_name##']['deactivatePlaceholder'](obj);
				$('#modul_' + obj.modulpath + ' .formRight #' + compId + '').remove();
    ...
    window['f_##modul_name##']['checkMaxChars'] = function (obj, el) { 
		...
		if(objConfigComponents[id_tcid].fields['content'].type == 'textarea'){
			...
			str = str.replace(/(<br \/>)/g, '\r\n');
			var maxchar = $('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="maxchars"]').val();
			var strShort = (maxchar > 0) ? str.substr(0, maxchar) : str;
			
			$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="content"]').val(strShort);
			strShort = strShort.replace(/(?:\r\n|\r|\n)/g, '<br>');
			$('#modul_' + obj.modulpath + ' .formRight .compboxOuterActive .content').html(strShort);
			objComponents.pages['page_' + compPageId][compId]['content'] = strShort;
	
	
			$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="content"]').closest('.formField').find('.descmaxchars').remove();
			if(maxchar > 0){
				var strlen = $('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="content"]').val().length;
				var rest = (maxchar * 1) - strlen;
				
				$('#modul_' + obj.modulpath + ' .formRight .formComponentsForm .fieldsetActive [name="content"]').closest('.formField').append('<div class="descmaxchars"><span class="restmaxchars">' + rest + '</span> ' + objText.restMaxChars + '</div>');
			}
		}
    ...
    window['f_##modul_name##']['childmodulWideOpen'] = function (obj) { 
		...
		childposLeft -= $('#modul_' + objModulParent.modulpath + ' .formRight').css('margin-left').replace('px','');
...
//		initBreadcrumbNavigation(obj);
    ...
    window['f_##modul_name##']['configComponentSaveDo'] = function (obj, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-configurations-save.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
    ...
    window['f_##modul_name##']['configComponentLoadDo'] = function (obj, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-configurations-load.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents .compboxOuter').removeClass('compboxOuterActive');
				$('#modul_' + obj.modulpath + ' .formRight .formComponentPreviewComponents .compboxOuter').remove();
    ...
    window['f_##modul_name##']['templatePublishDo'] = function (obj, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-publish.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				window['f_##modul_name##']['sendForm'](obj, 'close');
				
				window.setTimeout(function(){
					$.ajax({  
						url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-preview-create.php', 
						data: data,    
						type: 'post',          
						cache: false,  
						headers: {
    ...
    window['f_##modul_name##']['requestTranslationDo'] = function (obj, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-transrequest.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
    ...
    window['f_##modul_name##']['addBannerformat'] = function (obj, files) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-bannerformat-insert.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				$('#modul_' + obj.modulpath + ' .formRight .formComponentsThumbnails').append(thumbnails);
				window['f_##modul_name##']['initFormComponentThumbs'](obj);
				
				$('#modul_' + obj.modulpath + ' .formRightInner').css('display', 'block');
				if($('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuterActive').length == 0){
					$('#modul_' + obj.modulpath + ' .formRight .formComponentThumbOuter:first').addClass('formComponentThumbOuterActive');
					objComponents.id_temp = '';
					window['f_##modul_name##']['loadComponents'](obj);
				}
    ...
    window['f_##modul_name##']['deleteBannerformatDo'] = function (obj, bfid, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-bannerformat-delete.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				$('#form_' + obj.modulpath + ' .formRight .formComponentThumbOuter[data-bfid="' + bfid + '"]').closest('.formComponentThumbgroup').remove();
				for(var key in objP){
					for(var i = 1; i <= 3; i++){
    ...
    window['f_##modul_name##']['editBannerDo'] = function (obj, files) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-bannerformat-update.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				$('#form_' + obj.modulpath + ' .formRight .formComponentThumbOuter[data-bfid="' + bfid + '"]').closest('.formComponentThumbgroup').html(thumbnails);
    ...
    window['f_##modul_name##']['fileBannerformatDeleteDo'] = function (obj, tpid, mid, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-bannerformat-page-delete.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				var keyPage = 'page_' + $('#form_' + obj.modulpath + ' .formRight .formComponentThumbOuter[data-tp="' + tpid + '"]').attr('data-pageid');
				if(objComponents.pages[keyPage] != undefined) delete(objComponents.pages[keyPage]);
				$('#form_' + obj.modulpath + ' .formRight .formComponentThumbOuter[data-tp="' + tpid + '"]').remove();
    ...
    window['f_##modul_name##']['addComponentFileupload'] = function (obj, el) { 
		...
		if($('#form_' + obj.modulpath + ' .formRight .fileupload').length > 0 && filesUpload.length > 0){
			$('#form_' + obj.modulpath + ' .formRight .formComponentsTools').append('<div class="uploadOverlay"></div>');
			$('#form_' + obj.modulpath + ' .formRight .formComponentsTools .fileUploadOuter').clone().appendTo('#form_' + obj.modulpath + ' .formRight .formComponentsTools .uploadOverlay');
    ...
    window['f_##modul_name##']['saveComponentFileupload'] = function (obj, files) { 
		...
		var data = 'tpe=' + $('#form_' + obj.modulpath + ' .formRight .compboxOuterActive').attr('id');
		data += '&files=' + JSON.stringify(files);
		objResultFiles = {};
		
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-translations-components-fileupload-insert.php', 
			data: data,    
			type: 'post',          
			cache: false,  
			headers: {
			...
			success: function (result, status, jqXHR) {
				...
				//$('#form_' + obj.modulpath + ' .formRight .compboxOuterActive .componentUploadfile').css('background-image', 'url(' + objSystem.directoryInstallation + objSystem.pathMedia + files['x_x_x_content'].sysname + ')');
				$('#form_' + obj.modulpath + ' .formRight .compboxOuterActive .componentUploadfile').css('background-image', 'none');
				$('#form_' + obj.modulpath + ' .formRight .compboxOuterActive .componentUploadfile').html('<img src="' + objSystem.directoryInstallation + objSystem.pathMedia + files['x_x_x_content'].sysname + '">');

				objComponents.pages['page_' + compPageId][compId]['content'] = $('#form_' + obj.modulpath + ' .formRight .compboxOuterActive .content').html();
				$('#modul_' + obj.modulpath + ' .formLeft input[name="components"]').val(JSON.stringify(objComponents));
			}
		});
	}; 
...
//		if(objUser.right != 4){
//			var objData = JSON.parse($('#form_' + obj.modulpath + ' .formLeft .field_formdata').val());
//			var objDataComp = (objData.components != '' && objData.components != undefined) ? JSON.parse(objData.components) : {};
//			
...
//		
//		if(trans == 1){
//			$('#modul_' + obj.modulpath + ' .formRight .templatePublish').attr('data-type', 'translation');
//			$('#modul_' + obj.modulpath + ' .formRight .templatePublish').html(objText.requestTranslation);
//		}else{
			$('#modul_' + obj.modulpath + ' .formRight .templatePublish').attr('data-type', 'publish');
			$('#modul_' + obj.modulpath + ' .formRight .templatePublish').html(objText.TemplatePublish);
//		}
	}; 
