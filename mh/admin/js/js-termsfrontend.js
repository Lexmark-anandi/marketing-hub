(function () {
    ...
    window['f_##modul_name##']['rowExport'] = function (obj, el) { 
		...
		$.ajax({  
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-termsfrontend-export.php',    
			type: 'post',          
			data: data,       
			cache: false,
			headers: {
    ...
    window['f_##modul_name##']['rowImport'] = function (obj, el) { 
		...
		objDialog.urlForm = objSystem.directoryInstallation + objSystem.pathFormsAdmin + 'fo-termsfrontend-import.php';
    ...
    window['f_##modul_name##']['doImport'] = function (obj, objResultFiles) { 
		...
		$.ajax({
			url: objSystem.directoryInstallation + objSystem.pathFunctionsAdmin + 'fu-termsfrontend-import.php',       
			type: 'post',          
			data: data,       
			cache: false,  
			headers: {
