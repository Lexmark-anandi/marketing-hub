...
system('mysqldump -h ' . $CONFIG['db'][0]['host'] . ' -u ' . $CONFIG['db'][0]['user'] . ' -p' . $CONFIG['db'][0]['password'] . ' ' . $CONFIG['db'][0]['database'] . ' > ' . $CONFIG['system']['directoryRoot'] . 'backup/db/' . $file);
...
$aFiles = array_diff(scandir($CONFIG['system']['directoryRoot'] . 'backup/db/'), array('..', '.','.gitignore'));
sort($aFiles);
